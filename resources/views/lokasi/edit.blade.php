...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('lokasi.update', $lokasi->id) }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="kode_lokasi" id="kode_lokasi" class="border p-2 w-full" value="{{ old('kode_lokasi', $lokasi->kode_lokasi) }}">
        ...
        <div>
            ...
            <input type="text" name="nama_lokasi" id="nama_lokasi" class="border p-2 w-full" value="{{ old('nama_lokasi', $lokasi->nama_lokasi) }}">
        ...
        <div>
            ...
            <textarea name="keterangan" id="keterangan" class="border p-2 w-full">{{ old('keterangan', $lokasi->keterangan) }}</textarea>
